...
public class Principal {
    ...
    public void menu() {
        ...
        while (opcion != 0) {
            var menu = """
                    Ingresa la opcion de busqueda deseada:
                    	1.- Realizar buscar libro por titulo
                    	2.- Mostrar lista libros registrados
                    	3.- Mostrar lista autores registrados
                    	4.- Mostrar lista autores vivos en un determinado año
                    	5.- Mostrar lista libros por idioma
                    	0 - Salir
                    """;
